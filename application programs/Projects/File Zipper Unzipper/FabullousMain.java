...
class FabullousLogin extends Template implements ActionListener, Runnable
{
    JButton SUBMIT;
    ...
    FabullousLogin()
    {
        ...
        TopLabel.setText("Fabullous Zipper_UnZipper:Login");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==SUBMIT)
		{
			if(Validate(value1, value2) == false)
			{
				text1.setText("");
				text2.setText("");
				JOptionPane.showMessageDialog(this, "Minimum length 8 characters", "Fabullous Zipper UnZipper", JOptionPane.ERROR_MESSAGE);
			}
			if (value1.equals("FabullousAdmin") && value2.equals("FabullousAdmin"))
			{
			...
			else
			{
				...
				if(attemp == 0)
				{
					JOptionPane.showMessageDialog(this, "Number of attempts finished", "Fabullous Zipper UnZipper", JOptionPane.ERROR_MESSAGE);
					this.dispose();
					System.exit(0);
				}
...
class FabullousMain
{
	public static void main(String arg[])
	{
		try
		{
			FabullousLogin frame = new FabullousLogin();
